export default function Datenschutz() {
  return (
    <div className="container">
      ...
      <h2 id="einleitung-ueberblick" className="adsimple-312704709">
      ...
      <p>
        ...
        <br />
        <strong className="adsimple-312704709">Kurz gesagt:</strong> Wir
      ...
      <p>
        ...
        technische{" "}
        <strong className="adsimple-312704709">
          Begriffe leserfreundlich erklärt
        </strong>
        , Links zu weiterführenden Informationen geboten und{" "}
        <strong className="adsimple-312704709">Grafiken</strong> zum Einsatz
      ...
      <h2 id="anwendungsbereich" className="adsimple-312704709">
        Anwendungsbereich
      </h2>
      <p>
      ...
      <p>
        <strong className="adsimple-312704709">Kurz gesagt:</strong> Die
      ...
      <h2 id="rechtsgrundlagen" className="adsimple-312704709">
        Rechtsgrundlagen
      </h2>
      <p>
      ...
      <ol>
        <li className="adsimple-312704709">
          <strong className="adsimple-312704709">Einwilligung</strong> (Artikel
        ...
        <li className="adsimple-312704709">
          <strong className="adsimple-312704709">Vertrag</strong> (Artikel 6
        ...
        <li className="adsimple-312704709">
          <strong className="adsimple-312704709">Berechtigte Interessen</strong>{" "}
      ...
      <ul className="adsimple-312704709">
        <li className="adsimple-312704709">
          In <strong className="adsimple-312704709">Österreich</strong> ist dies
          das Bundesgesetz zum Schutz natürlicher Personen bei der Verarbeitung
          personenbezogener Daten (
          <strong className="adsimple-312704709">Datenschutzgesetz</strong>),
          kurz <strong className="adsimple-312704709">DSG</strong>.
        </li>
        <li className="adsimple-312704709">
          In <strong className="adsimple-312704709">Deutschland</strong> gilt
          das{" "}
          <strong className="adsimple-312704709">
            Bundesdatenschutzgesetz
          </strong>
          , kurz<strong className="adsimple-312704709"> BDSG</strong>.
        </li>
      </ul>
      <p>
      ...
      <h2 id="kontaktdaten-verantwortliche" className="adsimple-312704709">
        Kontaktdaten des Verantwortlichen
      </h2>
      <p>
        ...
        <br />
        E-Mail:{" "}
        <a href="mailto:kontakt@florianthoenelt.de">
          kontakt@florianthoenelt.de
        </a>
        <br />
        Impressum: <a href="/impressum/">Zum Impressum</a>
      </p>
      <h2 id="speicherdauer" className="adsimple-312704709">
        Speicherdauer
      </h2>
      <p>
      ...
      <h2 id="rechte-dsgvo" className="adsimple-312704709">
      ...
      <p>
        <strong className="adsimple-312704709">Kurz gesagt:</strong> Sie haben
      ...
      <h2 id="niedersachsen-datenschutzbehoerde" className="adsimple-312704709">
      ...
      <p>
        ...
        Barbara Thiel
        <br />
        <strong className="adsimple-312704709">Adresse: </strong>Prinzenstraße
        5, 30159 Hannover
        <br />
        <strong className="adsimple-312704709">Telefonnr.:</strong> 05 11/120-45
        00
        <br />
        <strong className="adsimple-312704709">E-Mail-Adresse:</strong>{" "}
        <a
          className="adsimple-312704709"
      ...
      <h2 id="datenuebertragung-drittlaender" className="adsimple-312704709">
        Datenübertragung in Drittländer
      </h2>
      <p>
      ...
      <h2 id="sicherheit-datenverarbeitung" className="adsimple-312704709">
        Sicherheit der Datenverarbeitung
      </h2>
      <p>
      ...
      <h2 id="tls-verschluesselung-https" className="adsimple-312704709">
      ...
      <h2 id="cookies" className="adsimple-312704709">
        Cookies
      </h2>
      ...
      <p>
        <strong className="adsimple-312704709">Name:</strong> _ga
        <br />
        <strong className="adsimple-312704709">Wert:</strong>
         GA1.2.1326744211.152312704709-9
        <br />
        <strong className="adsimple-312704709">Verwendungszweck:</strong>{" "}
        Unterscheidung der Websitebesucher
        <br />
        <strong className="adsimple-312704709">Ablaufdatum:</strong> nach 2
        Jahren
      </p>
      ...
      <h3 className="adsimple-312704709">
      ...
      <p>
        <a
          className="adsimple-312704709"
          href="https://support.microsoft.com/de-de/windows/l%C3%B6schen-und-verwalten-von-cookies-168dab11-0753-043d-7c16-ede5947fc64d?tid=312704709"
        >
      ...
      <p>
        <a
          className="adsimple-312704709"
          href="https://support.microsoft.com/de-de/microsoft-edge/cookies-in-microsoft-edge-l%C3%B6schen-63947406-40ac-c3b8-57b9-2a946a29ae09?tid=312704709"
        >
      ...
      <p>
        ...
        <strong className="adsimple-312704709">Einwilligung</strong> (Artikel 6
      ...
      <h2 id="webdesign-einleitung" className="adsimple-312704709">
      ...
      <p>
        ...
        <a
          className="adsimple-312704709"
          href="https://support.google.com/?hl=de"
        >
      ...
      <p>
        ...
        . Wir setzen Font Awesome gleichwohl nur ein, soweit Sie eine
      ...
      <h2 id="schlusswort" className="adsimple-312704709">
        Schlusswort
      </h2>
      <p>
